...
class CodeExecutionTool(BaseTool):
  """A built-in tool that is automatically invoked by Gemini 2 models to generate code and execute it.
  ...
  async def process_llm_request(
    ...
    if llm_request.model and 'gemini-1' in llm_request.model:
      raise ValueError('Code execution tool can not be used in Gemini 1.x.')

...
class TestTranscriptionManager:
    ...
    async def test_handle_input_transcription(self):
        ...
        await self.manager.handle_input_transcription(invocation_context, transcription)
    ...
    async def test_handle_output_transcription(self):
        ...
        # Handle transcription
        await self.manager.handle_output_transcription(invocation_context, transcription)
    ...
    async def test_error_handling_input_transcription(self):
        ...
        mock_session_service = AsyncMock()
        mock_session_service.append_event.side_effect = Exception("Session service error")
        invocation_context.session_service = mock_session_service
    ...
    def test_get_transcription_stats_with_events(self):
        ...
        output_event.output_transcription = types.Transcription(text="Model response")
        ...
        invocation_context.session.events = [
            input_event1, output_event, input_event2, regular_event
        ]
